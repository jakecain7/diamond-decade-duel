...
const Header = () => {
        ...
        <SheetContent side="right" className="w-[240px] bg-[#f5f0e1] border-l border-[#1d3557]/20">
          <nav className="flex flex-col gap-2 mt-8">
            ...
            {profile?.display_name && (
              <div className="px-4 py-2 text-sm text-[#1d3557]">
                Signed in as: <br />
  ...
  return (
    <header className="bg-[#f5f0e1] border-b border-[#1d3557]/10 py-2">
      <div className="container mx-auto flex justify-between items-center px-4">
        <Link to={user ? "/dashboard" : "/"} className="flex items-center">
          <img src="/lovable-uploads/ef092560-f20b-49f7-8e3e-09d6ae434ba1.png" alt="Grandstand Games" className="h-30 object-fill" />
        </Link>
