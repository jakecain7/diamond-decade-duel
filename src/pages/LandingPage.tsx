    ...
    <div className="min-h-[calc(100vh-68px)] bg-[#f5f0e1] flex flex-col items-center justify-center px-4 py-8">
      <div className="max-w-lg w-full bg-white p-8 rounded-lg shadow-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold text-[#1d3557] mb-4 font-serif italic">
            Game Portal
          </h1>
          <p className="text-lg text-[#1d3557]/80">
            Sign in to access our collection of exciting games!
          </p>
        </div>
      ...
      <div className="mt-8 text-center text-[#1d3557]/60">
        <p className="text-sm">
