...
import { useMidsummerDuelGame } from '@/hooks/useMidsummerDuelGame';
import LoadingDisplay from '@/components/grid/LoadingDisplay';
import GameHeader from '@/components/midsummer-duel/GameHeader';
...
const MidsummerDuelGame: React.FC = () => {
  const {
    currentPlayer,
    nextPlayer,
    score,
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-navy p-6">
        <div className="w-full max-w-[460px] bg-cream rounded-3xl p-6 shadow-lg">
          <h1 className="text-3xl font-heading text-center text-navy">MIDSUMMER DUEL</h1>
      ...
      <div className="w-full max-w-[460px] bg-cream rounded-3xl p-6 shadow-lg">
        ...
        {currentPlayer && (
          <PlayerCard 
            ...
            homeRuns={`${currentPlayer.totalASG} ASG`}
...
export default MidsummerDuelGame;
